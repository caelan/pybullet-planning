#!/usr/bin/env python3
"""Code to sample and evalute multiple possible actions. Input is the Instance candidate tree and its visiblity. Output the best action accordinge to reward function."""
...
if __name__ == "__main__":
    ...
    floor = p.loadURDF('models/table/table.urdf', globalScaling=0.3)
